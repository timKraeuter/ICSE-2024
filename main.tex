...
Until now, we have only received positive feedback regarding the visual debugger, which now has over 7360 downloads\footnote{Last checked on the 2nd of December, 2023, see \cite{timkrauterVisualDebuggerIntelliJ2023}.}.
