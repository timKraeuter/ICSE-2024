...
\keywords{Debugging, Visual Debugging, Visual Debugger, Visualization, IDE plugin, IDE extension, IDE Integration}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.6\linewidth]{images/visual-debugger-architecture.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\linewidth]{images/visual-debugger-DAP-architecture.pdf}
